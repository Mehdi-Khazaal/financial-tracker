...
const EmptyState: React.FC<Props> = ({
  iconPath, iconColor = '#6366f1', title, description, action,
}) => (
  <div className="card py-14 flex flex-col items-center text-center px-6">
    ...
    <p className="font-semibold text-text text-base mb-1">{title}</p>
    {description && <p className="text-sm text-muted max-w-xs leading-relaxed mb-5">{description}</p>}
